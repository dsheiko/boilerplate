...
export default function projectsRoutes( router, { projectModel } ) {
    ...
    router.delete( API_VER + "/projects/:id", async ( req, res ) => {
        try {
    ...
    router.put( API_VER + "/projects/:id", async ( req, res ) => {
        try {
    ...
    router.post( API_VER + "/projects", async ( req, res ) => {
        try {
    ...
    router.get( API_VER + "/projects/:id", async ( req, res ) => {
        try {
    ...
    router.get( API_VER + "/projects", async ( req, res ) => {
        try {
